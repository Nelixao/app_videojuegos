...
function seleccionarVideo(evt){
    evt.preventDefault(); // Previene el comportamiento por defecto del enlace
    const boton = evt.target; // El botón que ha sido clickeado
    const videoLink = boton.getAttribute('data-link'); // Obtener el enlace del video desde el atributo data-video
    insertarVideo(videoLink); // Insertar el video correspondiente
}
